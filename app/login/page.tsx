...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    async function checkAuth() {
      try {
        ...
        // Unauthenticated or network error, show login form
      } finally {
        if (isMounted) {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute -bottom-24 right-10 w-96 h-96 bg-primary-container/5 rounded-full pointer-events-none blur-3xl -z-10" />
